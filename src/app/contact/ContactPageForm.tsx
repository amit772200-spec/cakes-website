...
export default function ContactPageForm() {
  ...
  const inputClass = "bg-[#FFF8F9] rounded-2xl px-5 py-4 text-[#201A1B] outline-none border border-[#F8BBD0]/30 focus:bg-[#FFF9C4]/50 focus:border-[#F8BBD0] transition-all placeholder:text-[#514346]/50 w-full";

  if (submitted) {
    return (
      <div className="text-center py-8 flex flex-col items-center gap-4">
        <div className="text-6xl">🎂</div>
        <h3 className="text-2xl font-black text-[#201A1B]" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>
          תודה רבה!
        </h3>
        <p className="text-[#514346] text-lg">ניצור אתכם קשר בקרוב</p>
      </div>
    );
  }
