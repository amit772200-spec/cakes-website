      ...
      <main className="pt-16">
        ...
        <section className="relative min-h-[88vh] flex flex-col items-center justify-center px-6 overflow-hidden">
          ...
          <div className="z-10 flex flex-col sm:flex-row gap-4">
            ...
            <Link
              href="/contact"
              className="bg-white/60 border border-[#F8BBD0]/60 text-[#201A1B] px-10 py-4 rounded-full font-bold text-lg hover:bg-white/80 transition-all text-center"
            >
              צרו קשר
            </Link>
          </div>
          ...
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-20 items-center">
            <div className="w-full md:w-1/2 flex flex-col sm:grid sm:grid-cols-2 gap-6 flex-shrink-0">
              <div className="tile-float-1 bg-[#FFD8E4]/70 rounded-3xl overflow-hidden flex flex-col justify-end shadow-md hover:shadow-xl transition-shadow relative" style={{ minHeight: "220px" }}>
                <img src="https://images.unsplash.com/photo-1486427944299-d1955d23e34d?w=400&q=80" alt="חומרי גלם" className="absolute inset-0 w-full h-full object-cover opacity-40" />
                <div className="relative p-5">
                  <p className="font-bold text-[#31111D] text-base leading-snug" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>רק חומרי גלם מהשורה הראשונה</p>
                  <p className="text-[#31111D]/70 text-xs mt-1">שוקולד בלגי, קמח אורגני, פרי טרי בלבד</p>
                </div>
              </div>
              <div className="tile-float-2 bg-[#CFE9E7]/70 rounded-3xl overflow-hidden flex flex-col justify-end sm:translate-y-10 shadow-md hover:shadow-xl transition-shadow relative" style={{ minHeight: "220px" }}>
                <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80" alt="עיצוב אישי" className="absolute inset-0 w-full h-full object-cover opacity-35" />
                <div className="relative p-5">
                  <p className="font-bold text-[#00201F] text-base leading-snug" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>כל עוגה מעוצבת לפי הדמיון שלכם</p>
                  <p className="text-[#00201F]/70 text-xs mt-1">עיצוב אישי מלא לכל אירוע ובקשה</p>
                </div>
              </div>
            </div>
            <div className="w-full md:w-1/2">
              <h2 className="text-4xl md:text-5xl font-light text-[#201A1B] mb-8 leading-tight tracking-wide" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>
        ...
        <section className="py-28 px-6 md:px-20">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h2 className="text-4xl md:text-5xl font-light text-[#201A1B] mb-16 tracking-wide" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>
              העוגה שלכם בשלושה שלבים
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              <div className="flex flex-col items-center gap-5">
                <div className="w-20 h-20 rounded-full bg-[#FFD8E4]/80 flex items-center justify-center shadow-md">
                  <span className="text-3xl font-light text-[#9d4867]" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>1</span>
                </div>
                <h3 className="text-2xl font-light text-[#201A1B] tracking-wide" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>בוחרים עוגה</h3>
                <p className="text-[#514346]/80 font-light leading-relaxed text-center">גולשים בקטלוג שלנו ובוחרים את העוגה שדיברה אליכם — או מגיעים עם חלום משלכם</p>
              </div>
              <div className="flex flex-col items-center gap-5">
                <div className="w-20 h-20 rounded-full bg-[#CFE9E7]/80 flex items-center justify-center shadow-md">
                  <span className="text-3xl font-light text-[#00695C]" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>2</span>
                </div>
                <h3 className="text-2xl font-light text-[#201A1B] tracking-wide" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>ממלאים פרטים</h3>
                <p className="text-[#514346]/80 font-light leading-relaxed text-center">ממלאים את הטופס עם השם, הטלפון והמייל — זה לוקח פחות מדקה</p>
              </div>
              <div className="flex flex-col items-center gap-5">
                <div className="w-20 h-20 rounded-full bg-[#F5E6C8]/80 flex items-center justify-center shadow-md">
                  <span className="text-3xl font-light text-[#7a5c00]" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>3</span>
                </div>
                <h3 className="text-2xl font-light text-[#201A1B] tracking-wide" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>אנחנו יוצרים קשר</h3>
                <p className="text-[#514346]/80 font-light leading-relaxed text-center">אנחנו מתקשרים אליכם, מתאמים את כל הפרטים — ומכינים את עוגת החלומות שלכם</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="catalog" className="py-24 px-6 md:px-20">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-14">
              ...
              <h2 className="text-5xl md:text-6xl font-light text-[#201A1B] tracking-wide" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>
                גלריית עוגות
              </h2>
        ...
        <section className="py-28 px-6 md:px-20">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-14">
              ...
              <h2 className="text-4xl md:text-5xl font-light text-[#201A1B] tracking-wide" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>
                מה אומרים עלינו
              </h2>
            </div>
        ...
        {/* ─── CTA ──────────────────────────────────────────── */}
        <section id="contact-cta" className="py-24 text-center px-6">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-5xl md:text-6xl font-light text-[#31111D] mb-6 leading-tight tracking-wide" style={{ fontFamily: "Noto Serif Hebrew, serif" }}>
